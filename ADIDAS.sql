...
GROUP BY state
ORDER BY revenue;
    -- •	Are there any states that consistently show higher operating margins? 
SELECT
    y2020.state,
...
-- 3. Are certain sales methods consistently more profitable?
...
FROM sales.adidas_us;
-- 8.	Do revenue and profitability follow seasonal trends? (2021, 2022) -- Use for visual time trend
SELECT
